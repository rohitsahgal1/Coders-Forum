...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <p> This is a peer to peer knowledge sharing forum.</p>
    ...
    echo '<div class="container">
        ...
        <form action ="'. $_SERVER['REQUEST_URI'].'" method="post">
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Please keep your title as short and crisp as
                    possible.</small>
            </div>
            <div class="form-group">
       ...
       echo '<div class="container" >
             <h1 class="py-2">Start a Discussion</h1>
             <p class="lead">You are not logged in. Please login to start your Discussion.
             </p>
             </div>';
        ...
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="media-body">'.
                    ...
                    ' . $desc . '</div>'.
                    '<p class = "font-weight-bold my-0">Asked by:  ' . $row2['user_name']. '</p>
